...
class ProductPage(BasePage):
    ...
    def correct_price_in_basket(self):
        ...
        product_price_in_basket = self.browser.find_element(*ProductPageLocators.PRICE_PRODUCT_IN_BASKET).text
        assert product_price in product_price_in_basket, "The price of the item in the cart is not correct"
